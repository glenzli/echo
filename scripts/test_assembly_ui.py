...
with tempfile.TemporaryDirectory(prefix="echo-qml-contract-") as temporary:
    ...
    for name in ["EchoWindowChrome.qml", "MainTitleBar.qml", "IndependentTitleBar.qml", "EchoButton.qml", "EchoIconButton.qml", "Theme.qml", "SoundSemantics.qml", "WaveformView.qml", "SoundAssemblyClip.qml", "SoundGainEnvelope.qml", "SoundAutomation.js", "SoundAssemblyEditing.js", "EchoIcon.qml", "EchoComboBox.qml", "SpectralEditing.js", "NoiseProfileEditing.js", "NoiseReductionPanel.qml", "EchoSegmentedControl.qml", "SpectrogramView.qml", "SpectralRepairSurface.qml", "SoundAdjustmentDraft.qml", "EchoValueSpinBox.qml", "SoundAssemblyInspector.qml", "SoundDuckingPanel.qml", "EchoTimeSpinBox.qml", "EchoParameterSlider.qml", "EchoSwitch.qml"]:
