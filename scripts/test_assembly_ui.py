...
with tempfile.TemporaryDirectory(prefix="echo-qml-contract-") as temporary:
    ...
    for name in ["Theme.qml", "SoundSemantics.qml", "WaveformView.qml", "SoundAssemblyClip.qml", "SoundAssemblyEditing.js", "EchoIcon.qml", "EchoComboBox.qml", "SpectralEditing.js", "NoiseProfileEditing.js", "NoiseReductionPanel.qml", "EchoSegmentedControl.qml", "SpectrogramView.qml", "SpectralRepairSurface.qml", "SoundAdjustmentDraft.qml", "EchoTimeSpinBox.qml", "EchoParameterSlider.qml", "EchoSwitch.qml"]:
