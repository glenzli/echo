...
ApplicationWindow {
    ...
    readonly property string independentSmokeReport: independentDisclosureValidation ? disclosureSmoke.reportJson : independentClickValidation ? clickSmoke.reportJson : independentAiValidation ? aiSmoke.reportJson : smoke.reportJson
    readonly property int independentSmokeStage: independentDisclosureValidation ? disclosureSmoke.stage : independentClickValidation ? clickSmoke.stage : independentAiValidation ? aiSmoke.stage : smoke.stage
    IndependentEditorSmoke { id: smoke; shell: window; editor: editor; assembly: assembly; fixtureRoot: independentDisclosureValidation || independentAiValidation || independentClickValidation ? "" : independentSmokeRoot; reopening: independentSmokeReopen }
    IndependentAiSmoke { id: aiSmoke; shell: window; editor: editor; fixtureRoot: independentAiValidation && !independentClickValidation && !independentDisclosureValidation ? independentSmokeRoot : ""; reopening: independentSmokeReopen }
    property var assets: []
