...
ColumnLayout {
    ...
    readonly property var options: ({format:formatKey,sampleRate:Number(rate.currentText)*1000,channels:channels.currentIndex+1,bitrateKbps:Number(bitrate.currentText)})
