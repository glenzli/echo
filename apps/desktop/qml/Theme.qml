...
QtObject {
    ...
    readonly property color waveformSurface: effectiveDark ? "#171a1e" : "#eceff2"
    readonly property color waveformFill: effectiveDark ? "#9ba5ae" : "#66727c"
    readonly property color waveformPlayed: effectiveDark ? "#72a8dc" : "#3578b9"
    readonly property color waveformCenter: effectiveDark ? "#41474e" : "#c8cdd2"
