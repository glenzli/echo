...
pub use adjustment::{
    ...
    FadeCurveValueError, FadeCurves, MAX_COMPRESSOR_ATTACK_MILLIS, MAX_COMPRESSOR_MAKEUP_CENTIBELS,
    MAX_COMPRESSOR_RATIO_TENTHS, MAX_COMPRESSOR_RELEASE_MILLIS, MAX_COMPRESSOR_THRESHOLD_CENTIBELS,
    MAX_EQ_GAIN_CENTIBELS, MAX_GAIN_CENTIBELS, MAX_LOW_CUT_HERTZ, MIN_COMPRESSOR_ATTACK_MILLIS,
