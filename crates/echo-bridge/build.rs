...
const ENGINE_SOURCES: &[&str] = &[
    ...
    "src/ffmpeg_timing.cpp",
    "src/decode.cpp",
    "src/de_click_processor.cpp",
    "src/click_analysis.cpp",
    "src/de_esser.cpp",
    ...
    "src/spectrogram.cpp",
    "src/spectrogram_detail.cpp",
    "src/profiled_noise_reduction.cpp",
...
const ENGINE_ADDITIONAL_INPUTS: &[&str] = &[
    ...
    "src/playback_frame_ring.hpp",
    "src/prepared_pcm_reader.hpp",
